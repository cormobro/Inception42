...
echo ------------------------------------------
wp core install --url=${WORDPRESS_URL} --title=${WORDPRESS_URL} --admin_user=${WORDPRESS_ADMIN} --admin_password=${WORDPRESS_PASSWORD} --admin_email=${WORDPRESS_MAIL} --allow-root
echo ------------------------------------------
